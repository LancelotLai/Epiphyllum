$(document).ready(function() {
  ...
  $('#stage').addClass('bg-ayaroom-deep-night');
  counterChange();
  controlGuide();
  ...
  setTimeout(function() {
    $('#stage').css({
      "border-color": "rgba(219, 137, 255, 1)",
      "border-size": "40px",
      "border-style": "solid",
      "border-radius": "1px"
    });
    $('#textbox').css("background-color", "rgba(219, 137, 255, 0.5)");
    $('#flash').empty().fadeOut(2000, function() {
      $('#textbox').addClass('mouse-not-allowed');
      $('#char3').empty().html('<img src="images/Aya-New-Tower.png" alt="characterImage">').removeClass('charFilp');
      $('#spokesperson').html('<div class="aya"><h1>Aya (<span class="charFirstname"></span>)</h1></div>');
      $('#message').html('<div class="aya"><p>｢...｣<span id="textend">▷</span></p></div>');
      $('#backlog section').append('<div class="aya backlogborder"><h1>Aya (<span class="charFirstname"></span>)</h1><p>｢...｣</p></div>');
      $('.charFirstname').html(charFirstname);
      avoidMonkeyClick();
    });
  }, 3000);
  ...
  function controlTextBox() {
    ...
    if (textcounter == 2) {
      ...
      if (ideaOnAya == 3 || ideaOnAya == 1) {
        $('#char2').addClass('filter');
        $('#char3').removeClass('filter');
        $('#spokesperson, #message').empty();
        $('#spokesperson').html('<div class="aya"><h1>Aya (<span class="charFirstname"></span>)</h1></div>');
        $('#message').html('<div class="aya"><p>｢Um...｣<span id="textend">▷</span></p></div>');
        $('#backlog section').append('<div class="aya backlogborder"><h1>Aya (<span class="charFirstname"></span>)</h1><p>｢Um...｣</p></div>');
        $('.charFirstname').html(charFirstname);
        avoidMonkeyClick();
      }
    ...
    if (textcounter == 4) {
      $('#stage').animate({
        ...
        if (ideaOnAya == 3) {
          ...
          $('#char2').addClass('charFilp').html('<img src="images/Aya-New-TowerHappy.png" alt="characterImage">');
          $('#char3').addClass('charFilp').html('<img src="images/Jongun-UnderwearHappy.png" alt="characterImage">');
        }

        if (ideaOnAya == 1) {
          $('#stage').removeClass('bg-ayaroom-deep-night').addClass('bg-index2');
        ...
        $('#stage').animate({
          ...
          if (ideaOnAya == 3) {
            ...
            $('#message').html('<div class="aya"><p>｢Please help me to keep this headband.｣<span id="textend">▷</span></p></div>');
            $('#backlog section').append('<div class="aya backlogborder"><h1>Aya</h1><p>｢Please help me to keep this headband.｣</p></div>');
            $('.charFirstname').html(charFirstname);
            avoidMonkeyClick();
          }
          ...
          if (ideaOnAya == 1) {
            $('#spokesperson').html('<div class="aya"><h1>Aya</h1></div>');
            $('#message').html('<div class="aya"><p>｢Byebye...｣<span id="textend">▷</span></p></div>');
            $('#backlog section').append('<div class="aya backlogborder"><h1>Aya</h1><p>｢Byebye...｣</p></div>');
            $('.charFirstname').html(charFirstname);
            avoidMonkeyClick();
          }
        });
    ...
    if (textcounter == 5) {
      ...
      if (ideaOnAya == 3) {
        $('#char2').empty().html('<img src="images/Aya-TowerHappy.png" alt="characterImage">');
        $('#spokesperson').html('<div class="aya"><h1>Aya</h1></div>');
        $('#message').html('<div class="aya"><p>｢Until the day we have the future...｣<span id="textend">▷</span></p></div>');
        $('#backlog section').append('<div class="aya backlogborder"><h1>Aya</h1><p>｢Until the day we have the future...｣</p></div>');
        $('.charFirstname').html(charFirstname);
        avoidMonkeyClick();
      }
      ...
      if (ideaOnAya == 1) {
        ayacounter = 1;
        $('#spokesperson').html('<div class="aya"><h1>Aya</h1></div>');
        $('#message').html('<div class="aya"><p>｢My dearest...｣<span id="textend">▷</span></p></div>');
        $('#backlog section').append('<div class="aya backlogborder"><h1>Aya</h1><p>｢My dearest...｣</p></div>');
        $('.charFirstname').html(charFirstname);
        avoidMonkeyClick();
      }
    }
    ...
    if (textcounter == 6) {
      ...
      $('#stage').animate({
        ...
        $('#stage').removeClass('bg-ayaroom-deep-night').addClass('bg-room-day').animate({
          opacity: "1"
        }, 2000, 'linear', function() {
          ...
          setTimeout(function() {
            ...
            $('#message').html('<div class="Jongun"><p>｢Don\'t leave me...｣<span id="textend">▷</span></p></div>');
            $('#backlog section').append('<div class="Jongun backlogborder"><h1 class="charFirstname"></h1><p>｢Don\'t leave me...｣</p></div>');
            $('.charFirstname').html(charFirstname);
            avoidMonkeyClick();
    ...
    if (textcounter == 8) {
      $('#message').html('<div class="Jongun"><p>There is a headband on my wrist I never noticed before.<span id="textend">▷</span></p></div>');
      $('#backlog section').append('<div class="Jongun backlogborder"><h1 class="charFirstname"></h1><p>There is a headband on my wrist I never noticed before.</p></div>');
      $('.charFirstname').html(charFirstname);
      avoidMonkeyClick();
    }
    ...
    if (textcounter == 11) {
      ...
      $('#char1').empty().html('<img src="images/ShirleyNormal.png" alt="characterImage">').hide().fadeIn(1000, function(){
        $('#spokesperson, #message').empty();
        $('#spokesperson').html('<div class="Shirley"><h1>Shirley</h1></div>');
        $('#message').html('<div class="Shirley"><p>｢Well~ why suddenly saying this~｣<span id="textend">▷</span></p></div>');
        $('#backlog section').append('<div class="Shirley backlogborder"><h1>Shirley</h1><p>｢Well~ why suddenly saying this~｣</p></div>');
        $('.charFirstname').html(charFirstname);
        avoidMonkeyClick();
      });
    }
    ...
    if (textcounter == 12) {
      if(ideaOnKallen > 0 && shirleycounter == 2){
        ...
        $('.charFirstname').html(charFirstname);
        avoidMonkeyClick();
      } else if (ideaOnKallen > 0 && shirleycounter == 1) {
        ...
        $('.charFirstname').html(charFirstname);
        avoidMonkeyClick();
      } else if (ideaOnKallen > 0 && shirleycounter == 0) {
