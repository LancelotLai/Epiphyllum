...
function tutorial() {
  ...
  $('#yes, #no').click(function(){
    ...
    $("#option").fadeOut(1000, function(){$('#yesnooption').addClass('moveBack')});
});
};
...
function needTutorial() {
      ...
      function eventHandler() {
        ...
        if(videotimecounter == 5) {
          ...
          $('#char1').html('<img src="images/JongunHappy.png" alt="characterImage" class="charFilp">').fadeIn(1000);
          $('#char2').html('<img src="images/KallenHappy.png" alt="characterImage" class="charFilp">').fadeIn(1000);
        };

        if(videotimecounter == 9) {
          $('#textbox').fadeOut(1000, function(){$('#message').empty()});
        };
        ...
        if(videotimecounter == 82) {
          $('#textbox').fadeIn(1000, function(){
            ...
            $('#char1').animate({left:'700px'}, 2000, function(){$(this).animate({left:'0px'}, 2000)});
        });
...
function controlTextBox(){
  ...
  if (textcounter == 1) {
     ...
     $('#char1').html('<img src="images/JongunHappy.png" alt="characterImage" class="charFilp">').fadeIn(2000);
     $('#char2').html('<img src="images/KallenHappy.png" alt="characterImage" class="charFilp">').fadeIn(2000);
     battleControl();
  }
};
...
function battleControl() {
  ...
  function battleTimer() {
    ...
    $('#battleMagic').click(function (){$('#playerLife .life').css({'width': '300'})});

    function battleHandler(){
      console.log(battletimecounter);
      battletimecounter++;
      $('#enemyLife .life').css({'width' : $('#enemyLife .life').width() +1});
      $('#battleAttack').one('click', attack);
      $('#battleEvade').one('click', evade);
      $(document).one('keydown', function(e){
        if(e.which==65) {attack(); $('#battleAttack').addClass('battleKeyDown').removeClass('battleKeyup');};
        if(e.which==69) {evade(); $('#battleEvade').addClass('battleKeyDown').removeClass('battleKeyup');};
      });
      $(document).one('keyup', function(e){
        if(e.which==65) {$('#battleAttack').addClass('battleKeyup').removeClass('battleKeyDown');};
        if(e.which==69) {$('#battleEvade').addClass('battleKeyup').removeClass('battleKeyDown');};
...
function attack(){
  $('#playerLife .life').css({'width': $('#playerLife .life').width() + 1});
  $('#enemyLife .life').css({'width': $('#enemyLife .life').width() + 1});
  $('#char1').stop(false,true).animate({left: '+=1'}, 50, 'linear', function(){$(this).stop(false,true).animate({left: '-=1'}, 50, 'linear')});
