$(document).ready(function() {
  ...
  $('#bgm').html("<source src='audio/bgm/17 Occupied Thinking.mp3'>")
  ...
  function controlTextBox() {
    ...
    if (textcounter == 7) {
      ...
      setTimeout(function() {
        ...
        $('#spokesperson, #message').empty();
        $('#spokesperson').html('<div class="Cheresa"><h1>Cheresa</h1></div>');
        $('#message').html('<div class="Cheresa"><p>｢Is that your last word?｣<span id="textend">▷</span></p></div>');
        $('#backlog section').append('<div class="Cheresa backlogborder"><h1>Cheresa</h1><p>｢Is that your last word?｣</p></div>');
        $('#char2').removeClass('filter').animate({
          left: '-=250'
        }, 300, 'linear', function() {
          ...
          setTimeout(function() {
            ...
            setTimeout(function() {
              ...
              $('#spokesperson, #message').empty();
              $('#spokesperson').html('<div class="Cheresa"><h1>Cheresa</h1></div>');
              $('#message').html('<div class="Cheresa"><p>｢RIP｣</p></div>');
              $('#backlog section').append('<div class="Cheresa backlogborder"><h1>Cheresa</h1><p>｢RIP｣</p></div>');
              $('.charFirstname').html(charFirstname);
              $('#audio2').empty().html("<audio id='bgs'></audio>");
