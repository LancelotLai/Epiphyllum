$(document).ready(function() {
  ...
  setTimeout(function() {
    ...
    $('#char2').html('<img src="images/Kallen-Angry1.png" alt="characterImage">').addClass('filter charFilp');
  ...
  function controlTextBox() {
    ...
    if (textcounter == 4) {
      ...
      $('#message').html('<div class="kallen"><p>｢<span class="charFirstname"></span>, what are you doing.｣<span id="textend">▷</span></p></div>');
      $('#backlog section').append('<div class="kallen backlogborder"><h1>Kallen</h1><div class="kallen"><p>｢<span class="charFirstname"></span>, what are you doing.｣</p></div>');
      $('.charFirstname').html(charFirstname);
      avoidMonkeyClick();
    }
    ...
    if (textcounter == 7) {
      ...
      setTimeout(function() {
        ...
        $('#spokesperson, #message').empty();
        $('#spokesperson').html('<div class="kallen"><h1>Kallen</h1></div>');
        $('#message').html('<div class="kallen"><p>｢Is that your last word?｣<span id="textend">▷</span></p></div>');
        $('#backlog section').append('<div class="kallen backlogborder"><h1>Kallen</h1><p>｢Is that your last word?｣</p></div>');
        $('#char2').removeClass('filter');
        ...
        setTimeout(function() {
          ...
          setTimeout(function() {
            ...
            $('#spokesperson, #message').empty();
            $('#spokesperson').html('<div class="kallen"><h1>Kallen</h1></div>');
            $('#message').html('<div class="kallen"><p>｢I haven\'t think you got the ability back...it is my mistake｣</p></div>');
            $('#backlog section').append('<div class="kallen backlogborder"><h1>Kallen</h1><p>｢I haven\'t think you got the ability back...it is my mistake｣</p></div>');
            $('.charFirstname').html(charFirstname);
            $('#audio2').empty().html("<audio id='bgs'></audio>");
  ...
  function Fatality() {
    ...
    $('#flash').addClass('flashBlack').fadeIn(2000, function() {
      ...
      playBgm();
      $('#lyrics').addClass('kallen flashBlack');
