$(document).ready(function() {
  ...
  $("#audio1").html("<audio id='bgm' loop><source src='audio/bgm/fight2.mp3'></audio>");
  ...
  function needTutorial() {
    ...
    function eventHandler() {
      ...
      if (videotimecounter == 5) {
        ...
        if (ideaOnAya == 1) {
          $('#char2').html('<img src="images/AyaHappy4.png" alt="characterImage" class="charFilp">').fadeIn(1000);
        } else if (ideaOnAya == 2) {
          $('#char2').html('<img src="images/Aya-New-Happy2.png" alt="characterImage" class="charFilp">').fadeIn(1000);
  ...
  function playerWin() {
    ...
    $('#char2').droppable({
      drop: function(event, ui) {
        ...
        setTimeout(function() {
          window.location = 'Awakened-Aya.html'
        }, 4000);
      }
    });
  };
  ...
  function playerLose() {
    $('#stage').fadeOut(2000, function() {
      window.location = 'AnotherSide-Aya.html'
    });
  }
